...
const VERBIAGE_SENTENCES = {
  ...
  soft: [
    "I really like where we're going with this - any chance we could just tweak it a tiny bit?",
    "Hey, we're super close here - maybe we could add just one small thing to smooth this out?",
    "This is looking really solid! I'm thinking maybe one little touch could make it even better?",
    "I'm almost completely there with you - could we find just a small sweetener to seal the deal?",
    "Everything's lining up nicely! I'm just wondering if there's room for one light improvement?",
    "You've put together something really fair here - maybe just a slight tweak would lock it in?",
    "This is actually pretty strong - I think one small addition would really make it shine.",
    "I like what I'm seeing here - think we could polish it up just a little bit more?",
    "The offer definitely works for me - a tiny improvement would help me say yes even faster.",
    "I can see real value in this - could we maybe add something small to balance it out perfectly?",
    "The structure you've got is great - just a little more would make this absolutely perfect.",
    "This proposal is so close to being there - one gentle enhancement would totally close it for me.",
    "I think we're really aligned here - can we make it just a bit more appealing?",
    "I genuinely appreciate what you've put together - maybe we can enrich it slightly?",
    "You've done really well with this - perhaps a light sweetener would be the finishing touch?",
    "I'm comfortable with this direction, but one more small step could really secure it.",
    "This already feels pretty good - could we fine-tune it just a bit further?",
    "The numbers look fair to me - maybe a small sweetener would make it feel complete?",
    "I'm honestly inclined to agree - could you add just a little something more?",
    "The deal seems sound - a tiny improvement would make it absolutely excellent.",
    "You've given me a really good option here - could we soften it up slightly?",
    "I'm feeling positive about this - a bit more would really settle everything for me.",
    "The framework feels right - could we polish up some of the details?",
    "This is genuinely promising - could you add just one finishing touch?",
    "It's a fair balance we've got - perhaps we can make it a little sweeter?",
    "We're really close now - can you refine it just a touch more?",
    "This definitely works - maybe a small add-on would make it even stronger?",
    "I'd be ready to move forward if there's just a minor sweetener in there.",
    "Your proposal is solid - honestly, one small tweak could finalize everything.",
    "I can see a clear path forward - let's add just a little more weight to it.",
    "The agreement looks good to me - a small bonus would really confirm it.",
    "We've come so far together - one last sweetener could close this gap completely.",
    "I like the direction this is heading - can we enrich it slightly more?",
    "This makes a lot of sense - a small gesture would complete the picture.",
    "I really want to sign on this - give me just a little more to get there.",
    "The proposal has real strength - one soft addition would make it even stronger.",
    "We're nearly perfectly aligned - a slight improvement would definitely do it.",
    "I feel really good about this - a sweetener would make it even better.",
    "You've done most of the heavy lifting here - just need one more step.",
    "I'm ready to go if the deal gets just a little sweeter.",
    "It looks fine as is - a touch more would make it feel completely right.",
    "The offer is fair - a sweetener would really tip the scales for me.",
    "I think this is totally workable - can we smooth it out just a bit?",
    "This already appeals to me - a slight bonus would finalize everything.",
    "The plan is reasonable - maybe a little more support would help.",
    "I'm open to moving forward - a finishing detail would settle things nicely.",
    "This is a good deal - a tiny addition would make it absolutely excellent.",
    "I can definitely agree if we sweeten it just a touch.",
    "We're almost completely done - let's add one small incentive.",
    "The proposal is sound - one last improvement would close this nicely."
  ],
  
  // Harsh Sentences (51-100): When V1 = TRUE
  harsh: [
    "Look, this just isn't strong enough - you need to make it worthwhile for me.",
    "I've got to be honest, this deal lacks real substance - add something meaningful.",
    "I can't accept this as it stands - it needs to be made much stronger.",
    "What you're offering me here simply isn't enough.",
    "You need to sweeten this significantly or we're done talking.",
    "This proposal feels weak to me - you'll need to strengthen it considerably.",
    "I need to see much more value before I can take this seriously.",
    "These terms are insufficient - they need substantial improvement.",
    "This doesn't meet my basic requirements - you've got to fix it.",
    "Without major improvements, this just won't work for me.",
    "The offer is way too low - bring me something better.",
    "I won't proceed unless you add significant real value.",
    "This is completely unacceptable in its current form.",
    "You're going to need to do much better than this.",
    "This proposal lacks the strength I absolutely require.",
    "I'm not satisfied at all with what's on the table.",
    "This needs substantial enhancement before it becomes viable.",
    "The deal is too weak for me to move forward.",
    "I require much more than this to make it worthwhile.",
    "This doesn't justify my time without serious improvement.",
    "The terms need significant strengthening across the board.",
    "I won't accept anything less than substantial improvement.",
    "This proposal falls well short of my expectations.",
    "You'll need to add considerable value to get my attention.",
    "The offer requires major enhancement before I'll consider it.",
    "I need to see much more substance in this deal.",
    "This doesn't provide anywhere near adequate value.",
    "The deal needs fundamental strengthening from the ground up.",
    "I require substantial improvements before we can proceed.",
    "This is inadequate - you need to make it much stronger.",
    "The proposal lacks sufficient incentive for me to say yes.",
    "I need significantly more value to even consider this.",
    "This doesn't offer enough value for someone in my position.",
    "The terms require major improvement before I'll agree.",
    "I won't move forward without substantial changes being made.",
    "This needs dramatic enhancement to get my interest.",
    "The offer is too weak to be acceptable to me.",
    "I require much more substantial terms than what you're proposing.",
    "This doesn't meet even my minimum requirements.",
    "The proposal needs complete restructuring before I'll look at it.",
    "I need significantly better terms than what you're showing me.",
    "This is far from what I require to make a deal.",
    "The deal needs major strengthening in every area.",
    "I won't consider this without substantial improvement across the board.",
    "This lacks the real value I demand from any partnership.",
    "The terms are completely inadequate for what I'm looking for.",
    "I require dramatic improvements before we can proceed.",
    "This offer is insufficient by any reasonable measure.",
    "The proposal needs total reconstruction before I'll engage.",
    "I demand much better terms than what you're presenting."
  ]
};
