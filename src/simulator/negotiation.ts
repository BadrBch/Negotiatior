...
const VERBIAGE_SENTENCES = {
  ...
  soft: [
    "0: I really like where we're going with this - any chance we could just tweak it a tiny bit?",
    "1: Hey, we're super close here - maybe we could add just one small thing to smooth this out?",
    "2: This is looking really solid! I'm thinking maybe one little touch could make it even better?",
    "3: I'm almost completely there with you - could we find just a small sweetener to seal the deal?",
    "4: Everything's lining up nicely! I'm just wondering if there's room for one light improvement?",
    "5: You've put together something really fair here - maybe just a slight tweak would lock it in?",
    "6: This is actually pretty strong - I think one small addition would really make it shine.",
    "7: I like what I'm seeing here - think we could polish it up just a little bit more?",
    "8: The offer definitely works for me - a tiny improvement would help me say yes even faster.",
    "9: I can see real value in this - could we maybe add something small to balance it out perfectly?",
    "10: The structure you've got is great - just a little more would make this absolutely perfect.",
    "11: This proposal is so close to being there - one gentle enhancement would totally close it for me.",
    "12: I think we're really aligned here - can we make it just a bit more appealing?",
    "13: I genuinely appreciate what you've put together - maybe we can enrich it slightly?",
    "14: You've done really well with this - perhaps a light sweetener would be the finishing touch?",
    "15: I'm comfortable with this direction, but one more small step could really secure it.",
    "16: This already feels pretty good - could we fine-tune it just a bit further?",
    "17: The numbers look fair to me - maybe a small sweetener would make it feel complete?",
    "18: I'm honestly inclined to agree - could you add just a little something more?",
    "19: The deal seems sound - a tiny improvement would make it absolutely excellent.",
    "20: You've given me a really good option here - could we soften it up slightly?",
    "21: I'm feeling positive about this - a bit more would really settle everything for me.",
    "22: The framework feels right - could we polish up some of the details?",
    "23: This is genuinely promising - could you add just one finishing touch?",
    "24: It's a fair balance we've got - perhaps we can make it a little sweeter?",
    "25: We're really close now - can you refine it just a touch more?",
    "26: This definitely works - maybe a small add-on would make it even stronger?",
    "27: I'd be ready to move forward if there's just a minor sweetener in there.",
    "28: Your proposal is solid - honestly, one small tweak could finalize everything.",
    "29: I can see a clear path forward - let's add just a little more weight to it.",
    "30: The agreement looks good to me - a small bonus would really confirm it.",
    "31: We've come so far together - one last sweetener could close this gap completely.",
    "32: I like the direction this is heading - can we enrich it slightly more?",
    "33: This makes a lot of sense - a small gesture would complete the picture.",
    "34: I really want to sign on this - give me just a little more to get there.",
    "35: The proposal has real strength - one soft addition would make it even stronger.",
    "36: We're nearly perfectly aligned - a slight improvement would definitely do it.",
    "37: I feel really good about this - a sweetener would make it even better.",
    "38: You've done most of the heavy lifting here - just need one more step.",
    "39: I'm ready to go if the deal gets just a little sweeter.",
    "40: It looks fine as is - a touch more would make it feel completely right.",
    "41: The offer is fair - a sweetener would really tip the scales for me.",
    "42: I think this is totally workable - can we smooth it out just a bit?",
    "43: This already appeals to me - a slight bonus would finalize everything.",
    "44: The plan is reasonable - maybe a little more support would help.",
    "45: I'm open to moving forward - a finishing detail would settle things nicely.",
    "46: This is a good deal - a tiny addition would make it absolutely excellent.",
    "47: I can definitely agree if we sweeten it just a touch.",
    "48: We're almost completely done - let's add one small incentive.",
    "49: The proposal is sound - one last improvement would close this nicely.",
    "50: I'm really impressed with this framework - just one more small touch would seal it perfectly."
  ],
  
  // Harsh Sentences (51-100): When V1 = TRUE
  harsh: [
    "51: Look, this just isn't strong enough - you need to make it worthwhile for me.",
    "52: I've got to be honest, this deal lacks real substance - add something meaningful.",
    "53: I can't accept this as it stands - it needs to be made much stronger.",
    "54: What you're offering me here simply isn't enough.",
    "55: You need to sweeten this significantly or we're done talking.",
    "56: This proposal feels weak to me - you'll need to strengthen it considerably.",
    "57: I need to see much more value before I can take this seriously.",
    "58: These terms are insufficient - they need substantial improvement.",
    "59: This doesn't meet my basic requirements - you've got to fix it.",
    "60: Without major improvements, this just won't work for me.",
    "61: The offer is way too low - bring me something better.",
    "62: I won't proceed unless you add significant real value.",
    "63: This is completely unacceptable in its current form.",
    "64: You're going to need to do much better than this.",
    "65: This proposal lacks the strength I absolutely require.",
    "66: I'm not satisfied at all with what's on the table.",
    "67: This needs substantial enhancement before it becomes viable.",
    "68: The deal is too weak for me to move forward.",
    "69: I require much more than this to make it worthwhile.",
    "70: This doesn't justify my time without serious improvement.",
    "71: The terms need significant strengthening across the board.",
    "72: I won't accept anything less than substantial improvement.",
    "73: This proposal falls well short of my expectations.",
    "74: You'll need to add considerable value to get my attention.",
    "75: The offer requires major enhancement before I'll consider it.",
    "76: I need to see much more substance in this deal.",
    "77: This doesn't provide anywhere near adequate value.",
    "78: The deal needs fundamental strengthening from the ground up.",
    "79: I require substantial improvements before we can proceed.",
    "80: This is inadequate - you need to make it much stronger.",
    "81: The proposal lacks sufficient incentive for me to say yes.",
    "82: I need significantly more value to even consider this.",
    "83: This doesn't offer enough value for someone in my position.",
    "84: The terms require major improvement before I'll agree.",
    "85: I won't move forward without substantial changes being made.",
    "86: This needs dramatic enhancement to get my interest.",
    "87: The offer is too weak to be acceptable to me.",
    "88: I require much more substantial terms than what you're proposing.",
    "89: This doesn't meet even my minimum requirements.",
    "90: The proposal needs complete restructuring before I'll look at it.",
    "91: I need significantly better terms than what you're showing me.",
    "92: This is far from what I require to make a deal.",
    "93: The deal needs major strengthening in every area.",
    "94: I won't consider this without substantial improvement across the board.",
    "95: This lacks the real value I demand from any partnership.",
    "96: The terms are completely inadequate for what I'm looking for.",
    "97: I require dramatic improvements before we can proceed.",
    "98: This offer is insufficient by any reasonable measure.",
    "99: The proposal needs total reconstruction before I'll engage.",
    "100: I demand much better terms than what you're presenting."
  ]
};
